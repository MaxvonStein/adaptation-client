...
import SelectInput from "@material-ui/core/esm/Select/SelectInput";
...
var _ref = React.createElement(Input, {
  inputProps: { "aria-label": "naked" }
});

var _ref2 = React.createElement(FilledInput, null);

var IconSelect = React.forwardRef(function Select(props, ref) {
    ...
    _extends(
      {
        ...
        startAdornment: React.createElement(InputAdornment, {
          ...
          children: React.createElement(AccountCircle, null),
          disablePointerEvents: true
          // open the menu when the icon is
          // onClick:
          // })
        }),
        inputProps: _extends(
